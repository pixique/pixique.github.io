...
const EXERCISES = {
    'Lower A': {
        name: 'Shelf + Side',
        warmup: [
            { name: 'Broomstick Reset', time: '2 min', video: 'rmNf1BgigDk' },
            { name: 'Cat-Cow', time: '1 min', video: 'kqnua4rHVVA' },
            { name: 'Dead Bugs', time: '2 min', video: 'PR_s5N7kiXg' },
            { name: 'Floor I-Y-W', time: '2 min', video: 'egcK49J5Q-Y' },
        ...
        exercises: [
            ...
            { name: 'Seated Band Abduction', sets: '4×15-20', cue: 'Leaning forward vs upright', video: 'o7e6Jlj-hj8' },
            { name: 'Lateral Step-Ups', sets: '3×10 each', cue: 'Push hips back', video: 'sXW9aOo03P8' },
        ],
    ...
    'Lower B': {
        ...
        exercises: [
            { name: 'B-Stance RDL', sets: '4×8 each', isMain: true, cue: 'Shaving your legs with the bar', video: 'wp1r0s2Vdkk' },
            { name: 'High Step-Ups', sets: '3×10 each', cue: 'Slow 3-sec descent', video: 'KGyVfgh0fhk' },
            { name: 'Hyperextensions', sets: '3×12', cue: 'Round the upper back (glute focus)', video: 'W9y8xq4Ya_E' },
            { name: 'Yoga Ball Ham Curls', sets: '3×12', cue: 'Keep hips high', video: 'VesluYQgAwA' },
        ],
    ...
    'Lower C': {
        ...
        exercises: [
            { name: 'Single-Leg Hip Thrust', sets: '3×8 each', isMain: true, cue: 'Stop the pelvic twist', video: 'z9qjK_v105U' },
            ...
            { name: 'Band Walks', sets: '3×30 steps', cue: 'Knees pushed OUT', video: 'hSHdQkf7Myw' },
        ],
